...
SECRET_KEY = 'django-insecure-9t)_z+hw&^fvx4z=m4)j*x!+!=mj%llcxsm2+#coy#2r&_ix-0'
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Welcome to the Apni Car",

    # Copyright on the footer
    "copyright": "ApniCar Ltd",
